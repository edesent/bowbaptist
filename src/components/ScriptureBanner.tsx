export default function ScriptureBanner() {
  return (
    <section className="relative py-28 overflow-hidden bg-pine-deep">
      ...
      >
        ...
        <rect width="1440" height="460" fill="#14241b" />
        <rect width="1440" height="460" fill="url(#sbGlow)" />
        <path d="M0,300 L220,244 L440,296 L660,236 L880,294 L1100,240 L1320,296 L1440,260 L1440,460 L0,460 Z" fill="#1e3a2b" opacity="0.65" />
        <path d="M0,380 L260,336 L520,382 L780,334 L1040,382 L1300,338 L1440,372 L1440,460 L0,460 Z" fill="#21392b" />
      </svg>
      ...
      <div className="relative z-[1] max-w-3xl mx-auto px-6 text-center">
        <blockquote>
          ...
          <cite className="text-sm font-semibold tracking-[0.18em] uppercase text-oak-pale not-italic">
            — Matthew 5:14
          </cite>
        </blockquote>
      </div>
